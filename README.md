...
| + getId(): int                   |
| + getNome(): String              |
| + getLivrosEmprestados(): int    |
| + setNome(String): void          |
| + setLivrosEmprestados(int)      |
| + podeEmprestar(): boolean       |
| + getLimiteEmprestimos(): int    |  <<abstract>>
...
+----------------------------------+
| - NOME_ARQUIVO: String           |
| - FORMATO_DATA_HORA: DateTimeFmt |
+----------------------------------+
| + registrarCadastroLivro(...)    |
| + registrarCadastroUsuario(...)  |
| + registrarEmprestimo(...)       |
| + registrarDevolucao(...)        |
| + exibirHistoricoCompleto()      |
| + exibirHistoricoEmprestimos()   |
| + exibirHistoricoDevolucoes()    |
+----------------------------------+
...
| + buscarLivro(int): Livro                 |
| + buscarUsuario(int): Usuario             |
| + realizarEmprestimo(int, int): void      |
| + realizarDevolucao(int): void            |
| + listarLivros(): void                    |
| + listarUsuarios(): void                  |
